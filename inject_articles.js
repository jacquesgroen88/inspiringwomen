...
firstBatch.forEach(art => {
    ...
    articlesHtml += '<article class="list-post" style="border-top: 4px solid var(--primary-color); padding-top: 20px; display: flex; gap: 20px; align-items: flex-start; margin-bottom: 30px;">' +
        imgHtml +
